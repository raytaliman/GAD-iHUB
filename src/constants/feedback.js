...
const defaultBarangays = ['Poblacion', 'Barangay I', 'Barangay II', 'Barangay III', 'Barangay IV', 'Barangay V'];
...
export const ILOCOS_REGION_DATA = {
    'Ilocos Norte': {
        ...
        'Adams': defaultBarangays,
        'Bacarra': defaultBarangays,
        'Badoc': defaultBarangays,
        'Bangui': ['Abaca', 'Bacsil', 'Banban', 'Baruyen'],
        'Banna': defaultBarangays,
        'Burgos': ['Agaga', 'Bayog', 'Bobon', 'Buduan'],
        'Carasi': defaultBarangays,
        'Currimao': defaultBarangays,
        'Dingras': defaultBarangays,
        'Dumalneg': defaultBarangays,
        'Marcos': defaultBarangays,
        'Nueva Era': defaultBarangays,
        'Pagudpud': defaultBarangays,
        'Paoay': defaultBarangays,
        'Pasuquin': defaultBarangays,
        'Piddig': defaultBarangays,
        'Pinili': defaultBarangays,
        'San Nicolas': defaultBarangays,
        'Sarrat': defaultBarangays,
        'Solsona': defaultBarangays,
        'Vintar': defaultBarangays,
    },
    'Ilocos Sur': {
        ...
        'Alilem': defaultBarangays,
        'Banayoyo': defaultBarangays,
        'Bantay': defaultBarangays,
        'Burgos': defaultBarangays,
        'Cabugao': defaultBarangays,
        'Caoayan': defaultBarangays,
        'Cervantes': defaultBarangays,
        'Galimuyod': defaultBarangays,
        'Gregorio del Pilar': defaultBarangays,
        'Magsingal': defaultBarangays,
        'Nagbukel': defaultBarangays,
        'Narvacan': ['Abuor', 'Ambulogan', 'Aquibane', 'Banat'],
        'Quirino': defaultBarangays,
        'Salcedo': defaultBarangays,
        'San Emilio': defaultBarangays,
        'San Esteban': defaultBarangays,
        'San Ildefonso': defaultBarangays,
        'San Juan': defaultBarangays,
        'San Vicente': defaultBarangays,
        'Santa': defaultBarangays,
        'Santa Catalina': defaultBarangays,
        'Santa Cruz': defaultBarangays,
        'Santa Lucia': defaultBarangays,
        'Santa Maria': ['Ag-agrao', 'Ampamee', 'Baballasioan', 'Baliw'],
        'Santiago': defaultBarangays,
        'Santo Domingo': defaultBarangays,
        'Sigay': defaultBarangays,
        'Sinait': defaultBarangays,
        'Sugpon': defaultBarangays,
        'Suyo': defaultBarangays,
        'Tagudin': defaultBarangays,
    },
    'La Union': {
        'San Fernando City': ['Tanqui', 'Catbangen', 'Poro', 'Ilocanos Sur', 'Ilocanos Norte', 'Lingsat'],
        'Agoo': ['Ambitacay', 'Balawarte', 'Capas', 'Consolacion'],
        'Aringay': defaultBarangays,
        'Bacnotan': defaultBarangays,
        'Bagulin': defaultBarangays,
        'Balaoan': defaultBarangays,
        'Bangar': defaultBarangays,
        'Bauang': ['Central East', 'Central West', 'Baccuit Norte', 'Baccuit Sur'],
        'Burgos': defaultBarangays,
        'Caba': defaultBarangays,
        'Luna': defaultBarangays,
        'Naguilian': defaultBarangays,
        'Pugo': defaultBarangays,
        'Rosario': defaultBarangays,
        'San Gabriel': defaultBarangays,
        'San Juan': ['Taboc', 'Panicsican', 'Ili Norte', 'Ili Sur'],
        'Santo Tomas': defaultBarangays,
        'Santol': defaultBarangays,
        'Sudipen': defaultBarangays,
        'Tubao': defaultBarangays,
    },
    'Pangasinan': {
        ...
        'San Carlos City': defaultBarangays,
        'Agno': defaultBarangays,
        'Aguilar': defaultBarangays,
        'Alcala': defaultBarangays,
        'Anda': defaultBarangays,
        'Asingan': defaultBarangays,
        'Balungao': defaultBarangays,
        'Bani': defaultBarangays,
        'Basista': defaultBarangays,
        'Bautista': defaultBarangays,
        'Bayambang': defaultBarangays,
        'Binalonan': defaultBarangays,
        'Binmaley': defaultBarangays,
        'Bolinao': defaultBarangays,
        'Bugallon': defaultBarangays,
        'Burgos': defaultBarangays,
        'Calasiao': defaultBarangays,
        'Dasol': defaultBarangays,
        'Infanta': defaultBarangays,
        'Labrador': defaultBarangays,
        'Laoac': defaultBarangays,
        'Lingayen': ['Poblacion', 'Libsong East', 'Libsong West', 'Pangapisan North'],
        'Mabini': defaultBarangays,
        'Malasiqui': defaultBarangays,
        'Manaoag': defaultBarangays,
        'Mangaldan': defaultBarangays,
        'Mangatarem': defaultBarangays,
        'Mapandan': defaultBarangays,
        'Natividad': defaultBarangays,
        'Pozorrubio': defaultBarangays,
        'Rosales': defaultBarangays,
        'San Fabian': defaultBarangays,
        'San Jacinto': defaultBarangays,
        'San Manuel': defaultBarangays,
        'San Nicolas': defaultBarangays,
        'San Quintin': defaultBarangays,
        'Santa Barbara': defaultBarangays,
        'Santa Maria': defaultBarangays,
        'Santo Tomas': defaultBarangays,
        'Sison': defaultBarangays,
        'Sual': defaultBarangays,
        'Tayug': defaultBarangays,
        'Umingan': defaultBarangays,
        'Urbiztondo': defaultBarangays,
        'Villasis': defaultBarangays,
    }
};
